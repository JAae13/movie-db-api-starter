...
function getPopularMovies(){
    // the endpoint
     let url = "https://api.themoviedb.org/3/movie/popular?api_key=d87c5eef02f3f438fb975c0780c42302&language=en-US"; 
...
function getBirthYearMovies(e){
    ...
    if(year < 1940 || year > 2026 || year == ""){
        ...
        let begUrl = "https://api.themoviedb.org/3/discover/movie?api_key=d87c5eef02f3f438fb975c0780c42302&primary_release_year=";
        let endUrl = "&sort_by=revenue.desc&language=en-US&include_adult=false&include_video=false";
        let imgUrl = "https://image.tmdb.org/t/p/w400";
